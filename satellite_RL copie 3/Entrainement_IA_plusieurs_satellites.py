...
from gym_environment_2_satellites import DefEnvironnement_n_satellites  # Ton environnement Gym encapsulé
...
####ENTRAINEMENT IA POUR PLUSIEURS SATELLITES 
### !!!!! 
#!!!!!
### !!!
#### NE PAS CONFONDRE AVEC L'AUTRE ENTRAINEMENT
####BBABJBDJBEK
...
model.save("dqn_satellite_model_4_5orbites_2_satellites")
